  ...
  <div class="single-post-page">
    <section class="post">
        ...
        <div class="post-details">
            <div class="post-detail">Last updated on {{ lodadedPost.updatedDate }}.</div>
...
export default {
  asyncData(context) {
    return axios.get('https://nuxt-blog-c4b21-default-rtdb.firebaseio.com/posts/' + context.params.id + '.json')
    .then(res => {
      return {
        loadedPost: res.data
      }
